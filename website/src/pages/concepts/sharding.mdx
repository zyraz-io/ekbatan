...
- [Concepts → The dual-write trap](/concepts/the-dual-write-trap/) — why cross-shard actions are conceptually a dual write, and how sagas restore the guarantee
