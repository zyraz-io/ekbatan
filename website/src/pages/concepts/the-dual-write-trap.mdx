...
That's the whole pitch. The rest of the [Concepts](/concepts/) section explains how the pieces fit together to make that guarantee structural — not a convention you have to police.

## See also

- [The outbox: atomic state + events](/concepts/outbox/) — the schema and the persistence path
- [Actions, ActionPlan, ActionExecutor](/concepts/actions/) — the two-phase lifecycle that makes this automatic
- [Sagas: chaining committed actions](/concepts/sagas/) — how to coordinate multi-step workflows without pretending they are one transaction
