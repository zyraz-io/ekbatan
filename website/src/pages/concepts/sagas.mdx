...
- [Sharding strategies](/concepts/sharding/) - why cross-shard actions are rejected by default
- [The outbox: atomic state + events](/concepts/outbox/) - why each saga step gets a durable event
- [Actions, ActionPlan, ActionExecutor](/concepts/actions/) - why actions are not nested inside `perform()`
