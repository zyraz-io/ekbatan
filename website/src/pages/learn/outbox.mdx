...
<LearnPager current="outbox" />

## See also

- [Models and Entities](/learn/models-and-entities/) — only Models emit events
- [Actions, ActionPlan, ActionExecutor](/learn/actions/) — what stages and commits the changes
