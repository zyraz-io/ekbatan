...
- [`ekbatan-examples/spring-boot-wallet-rest-gradle-pg`](https://github.com/ekbatan-io/ekbatan/tree/main/ekbatan-examples/spring-boot-wallet-rest-gradle-pg) — runs the in-process `WalletMoneyDepositedEventHandler` end-to-end with an integration test that asserts the notification row appears
