...
<LearnPager current="sharding-strategies" />
...
- [Learn → Sagas](/learn/sagas/) — how to split multi-step workflows into committed actions and compensation steps
- [Learn → The dual-write trap](/learn/the-dual-write-trap/) — why cross-shard actions are conceptually a dual write
- [Learn → Actions, ActionPlan, ActionExecutor](/learn/actions/) — the per-shard transaction grouping happens inside Phase 2
