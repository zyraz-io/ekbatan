...
For the full motivation, read [The dual-write trap](/learn/the-dual-write-trap/).
...
For the conceptual version, read [The outbox: atomic state + events](/learn/outbox/).
...
For the deeper model rules, read [Models and Entities](/learn/models-and-entities/).
...
For the full lifecycle, read [Actions, ActionPlan, ActionExecutor](/learn/actions/).
...
1. [The dual-write trap](/learn/the-dual-write-trap/) — understand the failure mode Ekbatan removes.
2. [The outbox: atomic state + events](/learn/outbox/) — see why state and event rows commit together.
3. [Models and Entities](/learn/models-and-entities/) — learn which objects emit events and which do not.
4. [Actions, ActionPlan, ActionExecutor](/learn/actions/) — understand the two-phase lifecycle before writing your first action.
5. [Your first Action](/learn/your-first-action/) — write the wallet deposit action and inspect the event row.
