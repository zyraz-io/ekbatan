...
Add Ekbatan, `ekbatan-flyway`, your JDBC driver, and your stack's Flyway integration.
...
dependencies {
    ...
    jooqCodegen("org.flywaydb:flyway-mysql:12.0.0")      // (6) flyway-mysql also covers MariaDB
}`} />
...
dependencies {
    ...
    jooqCodegen("org.flywaydb:flyway-mysql:12.0.0")      // (6) flyway-mysql is required for MySQL too
}`} />
...
<CodeBlock filename="build.gradle.kts" language="kotlin" shadow="yellow" code={`dependencies {
    ...
    compileOnly("io.github.zyraz-io:ekbatan-annotation-processor:0.2.1")
    annotationProcessor("io.github.zyraz-io:ekbatan-annotation-processor:0.2.1")
    annotationProcessor("io.github.zyraz-io:ekbatan-micronaut:0.2.1")  // CRITICAL — see "(5) Micronaut needs the AP line"
...
<CodeBlock filename="build.gradle.kts" language="kotlin" shadow="orange" code={`dependencies {
    ...
    implementation("org.flywaydb:flyway-database-postgresql:12.0.0")  // (7) Flyway 10+ needs the per-dialect module
...
<CodeBlock filename="build.gradle.kts" language="kotlin" shadow="yellow" code={`dependencies {
    ...
    implementation("org.flywaydb:flyway-core:12.0.0")
    implementation("org.flywaydb:flyway-mysql:12.0.0")  // (7) Flyway 10+ needs the dialect module; flyway-mysql also covers MariaDB
...
<CodeBlock filename="build.gradle.kts" language="kotlin" shadow="orange" code={`dependencies {
    ...
    implementation("org.flywaydb:flyway-core:12.0.0")
    implementation("org.flywaydb:flyway-mysql:12.0.0")  // (7) Flyway 10+ needs the dialect module
...
<CodeBlock filename="src/main/java/io/example/wallet/startup/EkbatanShardFlywayMigrator.java" language="java" shadow="yellow" code={`import io.ekbatan.core.config.ShardingConfig;
...
<CodeBlock filename="src/main/java/io/example/wallet/startup/EkbatanShardFlywayMigrator.java" language="java" shadow="orange" code={`import io.ekbatan.core.config.ShardingConfig;
import io.ekbatan.flyway.FlywayMigrator;
