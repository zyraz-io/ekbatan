...
3. Add `io.github.ekbatan-io:ekbatan-native`.
...
- [`ekbatan-examples/*-native-*`](https://github.com/ekbatan-io/ekbatan/tree/main/ekbatan-examples) - 19 native wallet examples across Spring Boot, Quarkus, Micronaut, Gradle, Maven, the three supported databases, and the sharded Spring Boot PG example
