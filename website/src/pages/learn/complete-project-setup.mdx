...
<CodeBlock filename="build.gradle.kts" language="kotlin" shadow="yellow" code={`dependencies {
    ...
    compileOnly("io.github.ekbatan-io:ekbatan-annotation-processor:1.0.1")
    annotationProcessor("io.github.ekbatan-io:ekbatan-annotation-processor:1.0.1")
    annotationProcessor("io.github.ekbatan-io:ekbatan-micronaut:1.0.1")  // required for Micronaut DI
...
**Keep the Micronaut annotation processor.** The extra `annotationProcessor("io.github.ekbatan-io:ekbatan-micronaut:...")` line makes `@Ekbatan*` classes visible to Micronaut DI.
...
- [`ekbatan-examples/`](https://github.com/ekbatan-io/ekbatan/tree/main/ekbatan-examples) — 38 runnable framework wallet REST projects, plus saga and job-worker examples
