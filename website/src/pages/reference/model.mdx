...
| `ID` | The identifier type | [`Id<T>`](/reference/) or [`ShardedId<T>`](/concepts/sharding/) |
...
- [Concepts → Models and Entities](/concepts/models-and-entities/) — why two shapes, when to use each
...
- [Concepts → The outbox: atomic state + events](/concepts/outbox/) — how attached events become outbox rows
