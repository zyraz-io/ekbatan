...
- Source: [`ekbatan-core/src/main/java/io/ekbatan/core/action/ActionPlan.java`](https://github.com/ekbatan-io/ekbatan/blob/main/ekbatan-core/src/main/java/io/ekbatan/core/action/ActionPlan.java)
