...
- [Learn → Models and Entities](/learn/models-and-entities/) — why two shapes
...
- Source: [`ekbatan-core/src/main/java/io/ekbatan/core/domain/Entity.java`](https://github.com/ekbatan-io/ekbatan/blob/main/ekbatan-core/src/main/java/io/ekbatan/core/domain/Entity.java)
