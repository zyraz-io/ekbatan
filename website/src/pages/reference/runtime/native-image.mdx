...
lead: 'Ekbatan native-image support is split across your build tool, your framework integration, and the ekbatan-native module. This page explains what each layer is responsible for and which settings users normally need.'
---
...
- [Learn -> Compiling to a native binary](/learn/native-image/) - tutorial-level walkthrough
- [Wiring with Spring Boot](/reference/di/spring-boot/) - Spring AOT and Flyway details
- [Wiring with Quarkus](/reference/di/quarkus/) - Quarkus native and Flyway details
- [Wiring with Micronaut](/reference/di/micronaut/) - Micronaut native and serde details
- [`ekbatan-examples/*-native-*`](https://github.com/zyraz-io/ekbatan/tree/main/ekbatan-examples) - runnable native wallet examples
