...
Treat this as an escape hatch. If partial commits would require compensation, use a [saga](/learn/sagas/) instead of trying to make two shard transactions behave like one.
...
- [Actions](/learn/actions/) — the recommended path for business operations; uses `TransactionManager` internally
