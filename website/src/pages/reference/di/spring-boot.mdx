...
lead: 'What you write in a Spring Boot app to use Ekbatan: one starter dependency, four <code>@Ekbatan*</code> annotations on your own classes, and a property tree under <code>ekbatan.*</code>. The auto-config produces every framework bean for you and exposes <code>ActionExecutor</code> for injection.'
---
