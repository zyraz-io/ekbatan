...
lead: 'The on-disk shape of the outbox. For the *why* — the atomic state + events guarantee, the dual-write problem, the framework''s headline — read <a href="../concepts/outbox.md">The outbox: atomic state + events</a> first. This page is the SQL reference.'
---
