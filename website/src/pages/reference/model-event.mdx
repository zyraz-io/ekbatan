...
- [Learn → The outbox: atomic state + events](/learn/outbox/) — what happens to events after `withEvent`
- [Learn → Models and Entities](/learn/models-and-entities/) — why only Models emit events
...
- Source: [`ekbatan-core/src/main/java/io/ekbatan/core/domain/ModelEvent.java`](https://github.com/ekbatan-io/ekbatan/blob/main/ekbatan-core/src/main/java/io/ekbatan/core/domain/ModelEvent.java)
