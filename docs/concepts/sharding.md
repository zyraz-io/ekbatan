...
- [Reference → Sharding](../database/sharding.md) — APIs, configuration schema, `ShardedUUID` bit layout, `DatabaseRegistry.effectiveShard`, declarative `application.yml`
- [Concepts → Sagas](./sagas.md) — how to split multi-step workflows into committed actions and compensation steps
...
- [`ekbatan-examples/spring-boot-wallet-rest-gradle-sharded-pg`](https://github.com/ekbatan-io/ekbatan/tree/main/ekbatan-examples/spring-boot-wallet-rest-gradle-sharded-pg) — a runnable two-shard wallet using `EmbeddedBitsShardingStrategy`
- [`ekbatan-examples/spring-boot-wallet-rest-gradle-native-sharded-pg`](https://github.com/ekbatan-io/ekbatan/tree/main/ekbatan-examples/spring-boot-wallet-rest-gradle-native-sharded-pg) — the same sharded wallet with GraalVM `nativeTest` coverage
