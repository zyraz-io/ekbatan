...
- [Actions, ActionPlan, ActionExecutor](../concepts/actions.md) — where repository writes happen via the action lifecycle
- [Sharding](sharding.md) — how `effectiveShard(...)` resolves the right database
- [Multi-database (PostgreSQL / MySQL / MariaDB)](multi-database.md) — dialect-specific column types and JOOQ converters
- [Wiring with Spring Boot](../wiring/spring.md) / [Quarkus](../wiring/quarkus.md) / [Micronaut](../wiring/micronaut.md) — `@EkbatanRepository` discovery
