...
Treat this as an escape hatch. If partial commits would require compensation, use a [saga](../concepts/sagas.md) instead of trying to make two shard transactions behave like one.
