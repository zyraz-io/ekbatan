...
Periodic background work that should run on **a single** instance across a cluster — daily reports, hourly cleanups, periodic reconciliation. Built on a thin facade over [db-scheduler](https://github.com/kagkarlsson/db-scheduler).
