...
// @ConditionalOnProperty-style gates are evaluated before TestPropertyProvider runs in some
...
class WalletControllerIntegrationTest implements TestPropertyProvider {
    ...
    private final MySQLContainer mysql = new MySQLContainer("mysql:9.4.0")
    ...
    /**
     * Boots the testcontainer and emits the sharding properties Micronaut needs <em>before</em>
     * the application context is built. The {@code @Context}-eager {@link FlywayConfiguration}
     * picks these up via {@code ShardingConfig} and runs migrations.
     */
    @Override
    public Map<String, String> getProperties() {
        ...
        props.put("ekbatan.sharding.groups[0].members[0].configs.primaryConfig.jdbcUrl", mysql.getJdbcUrl());
        props.put("ekbatan.sharding.groups[0].members[0].configs.primaryConfig.username", mysql.getUsername());
        props.put("ekbatan.sharding.groups[0].members[0].configs.primaryConfig.password", mysql.getPassword());
        props.put(
        ...
        props.put("ekbatan.sharding.groups[0].members[0].configs.jobsConfig.jdbcUrl", mysql.getJdbcUrl());
        props.put("ekbatan.sharding.groups[0].members[0].configs.jobsConfig.username", mysql.getUsername());
        props.put("ekbatan.sharding.groups[0].members[0].configs.jobsConfig.password", mysql.getPassword());
        props.put(
        ...
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.jdbcUrl", mysql.getJdbcUrl());
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.username", mysql.getUsername());
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.password", mysql.getPassword());
        props.put(
