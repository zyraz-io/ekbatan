...
/**
 * End-to-end integration test for the wallet REST endpoints. Brings up Postgres via
 * {@link TestcontainersConfiguration} and lets {@link FlywayConfiguration}'s bean run
 * migrations before any Ekbatan bean initializes.
 */
@SpringBootTest(
