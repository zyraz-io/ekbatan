# quarkus-wallet-rest-gradle-mariadb

A standalone Quarkus 3.34 example that uses Ekbatan from Maven Central, backed by **MariaDB**.
Same domain shape as [`spring-boot-wallet-rest-gradle-pg`](../spring-boot-wallet-rest-gradle-pg) (Wallet model,
...
> This is the JVM-only baseline. A `quarkus-wallet-rest-gradle-native-mariadb` sibling for GraalVM native-image
> will follow.
...
- [`spring-boot-wallet-rest-gradle-pg`](../spring-boot-wallet-rest-gradle-pg) — the Spring Boot equivalent (Postgres).
