...
class WalletControllerIntegrationTest implements TestPropertyProvider {
    ...
    public Map<String, String> getProperties() {
        ...
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.jdbcUrl", postgres.getJdbcUrl());
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.username", postgres.getUsername());
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.password", postgres.getPassword());
        props.put("ekbatan.sharding.groups[0].members[0].configs.lockConfig.driverClassName", "org.postgresql.Driver");
