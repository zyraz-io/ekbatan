...
dependencies {
    ...
    // Gradle 9 + Spring Boot 4's BOM no longer pulls junit-platform-launcher transitively in
    // some configurations. Add it explicitly so the test runner can start.
