...
/**
 * Native (and packaged-jar) integration test for the wallet REST endpoints. Companion to
 * {@code WalletResourceIntegrationTest}, which exercises the same code paths in JVM mode via
 * direct {@code @Inject}; this test exercises them through the packaged artifact via HTTP.
 *
