# quarkus-wallet-rest-native

The GraalVM native-image variant of [`quarkus-wallet-rest`](../quarkus-wallet-rest). The domain
...
- [`quarkus-wallet-rest`](../quarkus-wallet-rest) — the JVM-only baseline. Start there.
- [`spring-boot-wallet-rest-native`](../spring-boot-wallet-rest-native) — the equivalent native
