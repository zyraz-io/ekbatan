...
public class DummyMoneyDepositedEvent extends ModelEvent<Dummy> {
    public final BigDecimal amount;
    public final BigDecimal newBalance;

    public DummyMoneyDepositedEvent(Id<Dummy> dummyId, BigDecimal amount, BigDecimal newBalance) {
