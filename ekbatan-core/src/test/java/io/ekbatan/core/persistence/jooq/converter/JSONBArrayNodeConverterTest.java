...
class JSONBArrayNodeConverterTest {

    private final JSONBArrayNodeConverter converter = new JSONBArrayNodeConverter();
    private final ObjectMapper objectMapper = new ObjectMapper();

    @Test
    void from_converts_jsonb_to_array_node() {
        // GIVEN
        var jsonb = JSONB.valueOf("[\"a\",\"b\",\"c\"]");
    ...
    @Test
    void to_converts_array_node_to_jsonb() {
        // GIVEN
