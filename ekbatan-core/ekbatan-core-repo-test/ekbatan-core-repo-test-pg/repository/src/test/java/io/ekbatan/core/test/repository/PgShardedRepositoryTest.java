...
public class PgShardedRepositoryTest extends BaseShardedRepositoryTest {
    ...
    private static TransactionManager createTransactionManager(PostgreSQLContainer container) {
        ...
        return new TransactionManager(primaryConnectionProvider, secondaryConnectionProvider, SQLDialect.POSTGRES);
    }
