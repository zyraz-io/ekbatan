...
@Testcontainers
public class MariadbBaseRepositoryTest extends BaseRepositoryTest {
    ...
    static {
        ...
        final var secondaryConnectionProvider = ConnectionProvider.hikariConnectionProvider(dataSourceConfig, false);
        TRANSACTION_MANAGER =
    ...
    public MariadbBaseRepositoryTest() {
