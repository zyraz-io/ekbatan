...
public class ShardedDummyRepository extends ModelRepository<Dummy, DummiesRecord, Dummies, UUID> {

    public ShardedDummyRepository(DatabaseRegistry databaseRegistry) {
        super(Dummy.class, DUMMIES, DUMMIES.ID, databaseRegistry, new EmbeddedBitsShardingStrategy());
    }
