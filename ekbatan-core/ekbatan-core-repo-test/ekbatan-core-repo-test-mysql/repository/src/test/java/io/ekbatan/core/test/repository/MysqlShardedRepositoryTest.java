...
public class MysqlShardedRepositoryTest extends BaseShardedRepositoryTest {
    ...
    private static TransactionManager createTransactionManager(MySQLContainer container) {
        ...
        return new TransactionManager(primaryConnectionProvider, secondaryConnectionProvider, SQLDialect.MYSQL);
    }
